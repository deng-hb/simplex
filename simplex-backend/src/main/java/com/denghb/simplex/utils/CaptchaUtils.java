...
//        Font font = new Font("Times New Roman", Font.ROMAN_BASELINE, fontHeight);
        ...
        public byte[] getImgData() throws IOException {
    ...
    public static void main(String[] args) {
        ...
        try {
            String path = "/tmp/" + new Date().getTime() + ".png";
     ...
     *
     */
    public static CaptchaResult generate() throws IOException {

        Captcha captcha = new Captcha(100, 40, 4, 50);

        CaptchaResult result = new CaptchaResult();
        result.setCode(captcha.getCode());
